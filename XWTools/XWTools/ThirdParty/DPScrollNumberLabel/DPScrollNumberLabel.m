...
//        numberCell.frame = CGRectMake((self.rowNumber + self.signRow - 1 - i) * self.cellWidth, 0, self.cellWidth, self.numberCellHeight);
        ...
        CGFloat leftMargin = (self.rowNumber + self.signRow - 1 - i) * self.cellWidth;
        [numberCell mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self).with.offset(leftMargin);
            make.top.equalTo(self);
            make.size.mas_equalTo(CGSizeMake(self.cellWidth, self.numberCellHeight));
        }];
...
//    self.signCell.frame = CGRectMake(0, 0, self.cellWidth, self.signCellHeight);
    ...
    [self.signCell mas_makeConstraints:^(MASConstraintMaker *make) {
