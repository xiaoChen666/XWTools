...
- (void)setSourArrVCs:(NSArray *)sourArrVCs {
    _sourArrVCs = sourArrVCs;
    while (self.parentVC.childViewControllers.count>0) {
        [[self.parentVC.childViewControllers lastObject] removeFromParentViewController];
    }

    self.childsVCs = sourArrVCs;
