...
@implementation JQScrollNumberLabel
...
- (instancetype)initWithNumber:(NSNumber *)originNumber font:(UIFont *)font textColor:(UIColor *)color {
    return [self initWithNumber:originNumber font:font textColor:color rowNumber:0];
}
