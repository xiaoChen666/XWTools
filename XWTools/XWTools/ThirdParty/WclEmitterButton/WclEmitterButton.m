...
//    explosionCell.contents       = (id)[UIImage imageNamed:@"store_icon"].CGImage;
...
- (void)layoutSubviews {
    ...
    CAEmitterCell *chargeEmitterCell =  _chargeLayer.emitterCells.firstObject;
    CAEmitterCell *explosionEmitterCell =  _explosionLayer.emitterCells.firstObject;
    chargeEmitterCell.contents = (id)[self imageForState:UIControlStateSelected].CGImage;
    explosionEmitterCell.contents = (id)[self imageForState:UIControlStateSelected].CGImage;
}
