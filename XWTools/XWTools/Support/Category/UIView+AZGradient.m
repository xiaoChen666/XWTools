...
- (void)CXWSetPublicGradient {
    
    NSArray *colors = @[[UIColor colorWithHexString:@"#1F83FF"],[UIColor colorWithHexString:@"#00C6FF"]];
    [self az_setGradientBackgroundWithColors:colors locations:nil startPoint:CGPointMake(0, 0.5) endPoint:CGPointMake(1.0, 0.5)];
}

//- (void)CXWSetGradientWithColor:(UIColor *)gradientColor {
//    
//    NSArray *colors = @[gradientColor,gradientColor];
//    [self az_setGradientBackgroundWithColors:colors locations:nil startPoint:CGPointMake(0, 0) endPoint:CGPointMake(1.0, 0)];
//}
