...
#import "XMBlackWriteFilter.h"

@implementation XMBlackWriteFilter


#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kGPUImageBlackWriteFragmentShaderString = SHADER_STRING
(
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageBlackWriteFragmentShaderString]))
    {
        return nil;
    }
